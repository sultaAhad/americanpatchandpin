        ...
        <div class="row">
            <div class="col-lg-12 align-items-center justify-content-center d-flex">
                <h1 class="main-section-heading" data-aos="fade-right" data-aos-duration="500" data-aos-offset="300"
                    data-aos-easing="ease-in-sine">Frequently Asked Questions
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="col-lg-10 mx-auto">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="para-delivery">Want to know more about our custom designed patches, pins, and coins? <br>
                        Learn more about the quality we provide at every step.
                    </p>
                </div>
            </div>
