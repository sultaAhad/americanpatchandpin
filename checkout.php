            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="checkout-table">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="conteniue">
                                <a href=""> <i class="fa fa-long-arrow-left" aria-hidden="true"></i>Continue Shopping
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6">
                        <h3 class="mb-5">Additional Information
                        </h3>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="methods-wrapper">
                            ...
                            <p class="personal-para">Your personal data will be used to process your order, support
                                your experience
