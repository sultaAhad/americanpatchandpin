            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p>Our embroidered custom patches are 100% customizable, along with our custom lapel pins,
                            trading pins,
                    ...
                    <div class="col-lg-6 ps-lg-5">
                        <form class="" method="POST">
                            <div class="row">
                                ...
                                <div class="form-group mt-2 col-lg-6">
                                    <label>Size</label>
                                    <input type="text" name="" id="" placeholder="Enter Size" class="form-control"
                                        required="">
                                </div>
                                <div class="form-group mt-2 col-lg-6">
                                    <label>Date Needed</label>
                                    <input type="date" name="" id="" placeholder="Enter Size" class="form-control"
                                        required="">
                                </div>
                                <div class="form-group mt-2 col-lg-12">
                                    <label>Message</label>
                                ...
                                <div class="form-group mt-2 col-lg-12">
                                    ...
                                    <input type="file" name="" id="" placeholder="Enter Size" class="form-control"
                                        required="">
                                </div>
